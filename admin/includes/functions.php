<?php
  ...
  if (isset($_POST['cat_add'])) {
      if (empty($_POST['cat_title'])) {
        ...
        $query = "INSERT INTO categories(title)VALUES('$cat_title')";
...
function add_post(){
  ...
  if (isset($_POST['publish'])) {
    ...
    $query = "INSERT INTO posts (title, user_id, author, post_category_id, body, image, created_at, tag,published) VALUES('$post_title','$post_author','$post_category','$post_category_id','$post_content','$target_file','$date','$post_comment_count','$post_views','$post_tags','$post_status')";
    $result = mysqli_query($connection, $query);
    if (!$result) {
      die("Could not send data " . mysqli_error($connection));
